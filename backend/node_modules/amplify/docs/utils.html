...
<body>
  <div id="container">
    ...
    <ul class="sections">
        ...
        <li id="section-1">
            ...
            <div class="content"><div class='highlight'><pre><span class="function"><span class="title">getType</span></span> = (obj) -&gt;
  <span class="keyword">if</span> obj <span class="keyword">is</span> <span class="literal">undefined</span> <span class="keyword">or</span> <span class="keyword">not</span> obj?
  ...
  <span class="keyword">return</span> classToType[Object.prototype.toString.call(obj)]

exports.getType = getType

<span class="function"><span class="title">isType</span></span> = (obj, type) -&gt;
  getType(obj) <span class="keyword">is</span> type
exports.isType = isType

<span class="function"><span class="title">isEmptyObject</span></span> = (obj) -&gt;
  <span class="keyword">return</span> <span class="literal">false</span> <span class="keyword">for</span> name <span class="keyword">of</span> obj
  <span class="keyword">return</span> <span class="literal">true</span>

exports.isEmptyObject = isEmptyObject</pre></div></div>
